...
export const WandSparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" >
    ...
    <path d="M13 22 22 13" />
    <path d="m19 2 1 1" /><path d="m10.5 8.5 1 1" /> <path d="m3 14 1 1" />
  </svg>
);
...
export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 5a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Zm0 0a3 3 0 1 0 5.993.13a3 3 0 0 0-5.993-.13Zm0 0V3m0 4v3m0 3a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Zm0 0a3 3 0 1 0 5.993.13a3 3 0 0 0-5.993-.13Zm0 0v-3m-3 1.5a3 3 0 1 0-3.867 2.87A3 3 0 0 0 5 15.5m0 0H3m2 0h3m4.5 1.5a3 3 0 1 0 2.87-3.867A3 3 0 0 0 12.5 12m0 0V9m0 3v3.5m0 0a3 3 0 1 0 3.867 2.87A3 3 0 0 0 19 15.5m0 0h2m-2 0h-3" />
    </svg>
);
